...
# Change directory
setwd("/home/rajesh/Dropbox/Documents/CAN_IMG/01_PMCRC/Projects/00_Projects/01_FLOMICS/00_Methylation_Analysis/01_Clustering/850k/01_kmeans/")
...
#gap_stat <- clusGap(t(df), FUN = kmeans, nstart = 25, K.max = 10, B = 328)
...
kclust <- kmeans(df, centers = k_number)
